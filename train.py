...
class GPT(nn.Module):
    ...
    def setup_optimizer(self, unembedding_lr=0.004, embedding_lr=0.2, matrix_lr=0.02,
        ...
        if value_embed_lr is None:
            value_embed_lr = embedding_lr
        ...
        param_groups = [
            ...
            dict(kind='adamw', params=value_embeds_params, lr=value_embed_lr * dmodel_lr_scale, betas=adam_betas, eps=1e-10, weight_decay=0.0),
...
VALUE_EMBED_LR = 1.0    # learning rate for value embeddings (Adam); higher than wte since VE grads are sparse/underfit
